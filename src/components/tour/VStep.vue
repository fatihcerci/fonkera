...
export default {
  ...
  setup(props, context) {
    ...
    const getPlacement = computed(() => {
      return DEFAULT_STEP_OPTIONS.placement
    })
    ...
    return { hash, isButtonEnabled, VStep, getPlacement }
  }
}
</script>
...
<style lang="scss" scoped>
  ...
  .v-step .v-step__arrow {
    border-color: #5f56be; /* #ffc107, #35495e */
  ...
  .v-step__header {
    ...
    padding: 0.5rem;
    background: linear-gradient(180deg,rgba(89, 81, 175, 0.9), #7267e9);
